...
expName = 'goNogoAlpha1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\goNogoAlpha1\\goNogoAlpha1_lastrun.py',
...
taskLoop = data.TrialHandler(nReps=1, method='random', 
...
for thisTaskLoop in taskLoop:
    ...
    for thisTrialsLoop in trialsLoop:
        ...
        for thisComponent in trialComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        trialsLoop.addData('trialBlue.started', trialBlue.tStartRefresh)
        trialsLoop.addData('trialBlue.stopped', trialBlue.tStopRefresh)
        trialsLoop.addData('trialOrange.started', trialOrange.tStartRefresh)
        trialsLoop.addData('trialOrange.stopped', trialOrange.tStopRefresh)
